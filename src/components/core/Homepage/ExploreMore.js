...
<div className='flex flex-row rounded-full mt-5 bg-richblack-800 mb-5 border-richblack-100 '>
    {
        tabName.map((element,index) => {
            return (
                <div className={`text-[16px] flex flex-row items-center gap-2 ${currentTab=== element
                 ? "bg-richblack-900  text-richblack-5 font-medium":"text-richblack-200 "} rounded-full transition-all duration-200
...
<div className='hidden lg:block lg:h-[150px] '></div>
    {/* {course card} */}
    <div className=' flex flex-row gap-9 mt-5 flex-wrap justify-center w-full lg:absolute right-0 left-0 mr-auto ml-auto'>
        {
