...
<div>
  ...
  <p className='text-base'>{element.Description}</p>
    ...
    <div className='relative shadow-blue-200'>
      <img src={timlineimage} alt="" srcset="" className='shadow-white object-cover h-fit' />
      <div className='absolute bg-caribbeangreen-700 flex flex-row text-white
      uppercase py-10 left-[50%] translate-x-[-50%] translate-y-[-50%]'>
<div className='flex flex-row gap-5 items-center  border-r border-caribbeangreen-300 px-7'>
  <p className='text-3xl font-bold '>10</p>
<p className='text-caribbeangreen-300 text-sm uppercase'>years Experience</p>
</div>

<div className='flex flex-row gap-5 items-center   border-caribbeangreen-300 px-7'>
<p className='text-3xl font-bold '>250</p>
<p className='text-caribbeangreen-300 text-sm uppercase'>TYPE OF COURSES</p>
</div>
      </div>
    </div>
</div>
