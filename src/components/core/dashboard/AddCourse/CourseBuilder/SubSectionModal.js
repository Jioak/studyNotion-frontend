...
const handleEditSubSection =async  () => {
    ...
    formData.append('subSecctionId',modalData._id);
...
<RxCross1 className="text-2xl text-richblack-5" />
    ...
    <form omSubmit={handleSubmit(onSubmit)}
     className="space-y-8 px-8 py-10">
        ...
        <div  className="flex flex-col space-y-2">
            ...
            {...register('lectureTitlle',{required:true})}
        ...
        <div className="flex flex-col space-y-2">
            <label  className="text-sm text-richblack-5" htmlFor='lectureDesc'>
                Lecture Description{" "}  {!view && <sup className="text-pink-200">*</sup>}</label>
